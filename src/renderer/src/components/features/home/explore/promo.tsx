	...
	return (
		...
		>
			<div className="relative w-full p-5">
				{/* background effects */}
				<div
					className="absolute -top-12 -left-8 w-32 h-32 md:w-48 md:h-48 rounded-xl blur-3xl pointer-events-none"
					style={{
						backgroundColor:
				...
				/>
				<div
					className="absolute -bottom-8 -right-8 w-24 h-24 md:w-32 md:h-32 rounded-xl blur-2xl pointer-events-none"
					style={{
						backgroundColor:
