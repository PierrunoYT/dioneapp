...
function App() {
	...
	return (
		<ThemeProvider>
			<TranslationProvider>
				<div className="h-screen w-screen overflow-hidden bg-background-light dark:bg-background-dark text-text-primary-light dark:text-text-primary-dark" id="main">
					<Titlebar />
